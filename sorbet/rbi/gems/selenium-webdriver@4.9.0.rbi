...
class Selenium::WebDriver::SeleniumManager
  class << self
    ...
    #
    # source://selenium-webdriver//lib/selenium/webdriver/common/selenium_manager.rb#64
    def binary; end

    # @api private
    #
    # source://selenium-webdriver//lib/selenium/webdriver/common/selenium_manager.rb#84
    def run(*command); end
  end
end
