...
class Zip::ExtraField::IUnix < ::Zip::ExtraField::Generic
  # @return [IUnix] a new instance of IUnix
  #
  ...
  # Sets the attribute gid
  #
  # @param value the value to set the attribute gid to.
  #
  # source://rubyzip//lib/zip/extra_field/unix.rb#13
  def gid=(_arg0); end
...
class Zip::ExtraField::NTFS < ::Zip::ExtraField::Generic
  # @return [NTFS] a new instance of NTFS
  #
  ...
  # Sets the attribute atime
  #
  # @param value the value to set the attribute atime to.
  #
  # source://rubyzip//lib/zip/extra_field/ntfs.rb#18
  def atime=(_arg0); end
  ...
  # Sets the attribute ctime
  #
  # @param value the value to set the attribute ctime to.
  #
  # source://rubyzip//lib/zip/extra_field/ntfs.rb#18
  def ctime=(_arg0); end
  ...
  #
  # @param value the value to set the attribute mtime to.
  #
  # source://rubyzip//lib/zip/extra_field/ntfs.rb#18
  def mtime=(_arg0); end
...
class Zip::ExtraField::OldUnix < ::Zip::ExtraField::Generic
  # @return [OldUnix] a new instance of OldUnix
  #
...
class Zip::ExtraField::UniversalTime < ::Zip::ExtraField::Generic
  # @return [UniversalTime] a new instance of UniversalTime
  #
...
class Zip::ExtraField::Zip64 < ::Zip::ExtraField::Generic
  # @return [Zip64] a new instance of Zip64
  #
  ...
  # Sets the attribute disk_start_number
  #
  # @param value the value to set the attribute disk_start_number to.
  #
  # source://rubyzip//lib/zip/extra_field/zip64.rb#4
  ...
  # Sets the attribute original_size
  #
  # @param value the value to set the attribute original_size to.
  #
  # source://rubyzip//lib/zip/extra_field/zip64.rb#4
  ...
  # Sets the attribute relative_header_offset
  #
  # @param value the value to set the attribute relative_header_offset to.
  #
  # source://rubyzip//lib/zip/extra_field/zip64.rb#4
...
class Zip::ExtraField::Zip64Placeholder < ::Zip::ExtraField::Generic
  # @return [Zip64Placeholder] a new instance of Zip64Placeholder
  #
