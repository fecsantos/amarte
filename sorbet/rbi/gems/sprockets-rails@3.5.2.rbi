...
module Rails
  class << self
    # source://railties/6.1.7.8/lib/rails.rb#38
    def app_class; end

    # source://railties/6.1.7.8/lib/rails.rb#38
    def app_class=(_arg0); end

    # source://railties/6.1.7.8/lib/rails.rb#39
    def application; end

    # source://railties/6.1.7.8/lib/rails.rb#37
    def application=(_arg0); end

    # source://railties/6.1.7.8/lib/rails.rb#112
    def autoloaders; end

    # source://railties/6.1.7.8/lib/rails.rb#50
    ...
    # source://railties/6.1.7.8/lib/rails.rb#46
    def configuration; end

    # source://railties/6.1.7.8/lib/rails.rb#72
    def env; end

    # source://railties/6.1.7.8/lib/rails.rb#79
    def env=(environment); end

    # source://railties/6.1.7.8/lib/rails/gem_version.rb#5
    def gem_version; end

    # source://railties/6.1.7.8/lib/rails.rb#92
    def groups(*groups); end

    # source://railties/6.1.7.8/lib/rails.rb#43
    ...
    # source://railties/6.1.7.8/lib/rails.rb#108
    def public_path; end

    # source://railties/6.1.7.8/lib/rails.rb#63
    def root; end

    # source://railties/6.1.7.8/lib/rails/version.rb#7
    def version; end
  end
end
...
class Rails::Application < ::Rails::Engine
  # source://railties/6.1.7.8/lib/rails/application.rb#128
  ...
  # source://railties/6.1.7.8/lib/rails/engine.rb#520
  def build_middleware_stack; end

  # source://railties/6.1.7.8/lib/rails/application.rb#402
  def config; end

  # source://railties/6.1.7.8/lib/rails/application.rb#406
  def config=(_arg0); end

  # source://railties/6.1.7.8/lib/rails/application.rb#241
  def config_for(name, env: T.unsafe(nil)); end

  # source://railties/6.1.7.8/lib/rails/application.rb#322
  def console(&blk); end

  # source://railties/6.1.7.8/lib/rails/application.rb#450
  def credentials; end

  # source://railties/6.1.7.8/lib/rails/application.rb#422
  def credentials=(_arg0); end

  # source://railties/6.1.7.8/lib/rails/application.rb#123
  def default_url_options(*_arg0, &_arg1); end

  # source://railties/6.1.7.8/lib/rails/application.rb#123
  def default_url_options=(arg); end

  # source://railties/6.1.7.8/lib/rails/application.rb#515
  def eager_load!; end

  # source://railties/6.1.7.8/lib/rails/application.rb#481
  def encrypted(path, key_path: T.unsafe(nil), env_key: T.unsafe(nil)); end

  # source://railties/6.1.7.8/lib/rails/application.rb#268
  def env_config; end

  # source://railties/6.1.7.8/lib/rails/application.rb#121
  def executor; end

  # source://railties/6.1.7.8/lib/rails/application.rb#328
  def generators(&blk); end

  # source://railties/6.1.7.8/lib/rails/application.rb#494
  def helpers_paths; end

  # source://railties/6.1.7.8/lib/rails/application.rb#389
  def initialize!(group = T.unsafe(nil)); end

  # source://railties/6.1.7.8/lib/rails/application.rb#149
  def initialized?; end

  # source://railties/6.1.7.8/lib/rails/application.rb#310
  def initializer(name, opts = T.unsafe(nil), &block); end

  # source://railties/6.1.7.8/lib/rails/application.rb#396
  def initializers; end

  # source://railties/6.1.7.8/lib/rails/application.rb#339
  def isolate_namespace(mod); end

  # source://railties/6.1.7.8/lib/rails/application.rb#173
  def key_generator; end

  # source://railties/6.1.7.8/lib/rails/application.rb#199
  def message_verifier(verifier_name); end

  # source://railties/6.1.7.8/lib/rails/application.rb#510
  ...
  # source://railties/6.1.7.8/lib/rails/application.rb#303
  def rake_tasks(&block); end

  # source://railties/6.1.7.8/lib/rails/application.rb#168
  ...
  # source://railties/6.1.7.8/lib/rails/application.rb#365
  def require_environment!; end

  # source://railties/6.1.7.8/lib/rails/application.rb#370
  def routes_reloader; end

  # source://railties/6.1.7.8/lib/rails/application.rb#153
  def run_load_hooks!; end

  # source://railties/6.1.7.8/lib/rails/application.rb#316
  def runner(&blk); end

  # source://railties/6.1.7.8/lib/rails/application.rb#119
  def sandbox; end
  ...
  # source://railties/6.1.7.8/lib/rails/application.rb#433
  def secret_key_base; end

  # source://railties/6.1.7.8/lib/rails/application.rb#408
  def secrets; end

  # source://railties/6.1.7.8/lib/rails/application.rb#422
  def secrets=(_arg0); end

  # source://railties/6.1.7.8/lib/rails/application.rb#334
  def server(&blk); end

  # source://railties/6.1.7.8/lib/rails/application.rb#490
  def to_app; end

  # source://railties/6.1.7.8/lib/rails/application.rb#377
  def watchable_args; end

  protected

  # source://railties/6.1.7.8/lib/rails/application.rb#592
  def default_middleware_stack; end

  # source://railties/6.1.7.8/lib/rails/application.rb#558
  def ordered_railties; end

  # source://railties/6.1.7.8/lib/rails/application.rb#580
  def railties_initializers(current); end

  # source://railties/6.1.7.8/lib/rails/application.rb#547
  def run_console_blocks(app); end

  # source://railties/6.1.7.8/lib/rails/application.rb#537
  def run_generators_blocks(app); end

  # source://railties/6.1.7.8/lib/rails/application.rb#542
  def run_runner_blocks(app); end

  # source://railties/6.1.7.8/lib/rails/application.rb#552
  def run_server_blocks(app); end

  # source://railties/6.1.7.8/lib/rails/application.rb#526
  def run_tasks_blocks(app); end

  # source://railties/6.1.7.8/lib/rails/application.rb#597
  def validate_secret_key_base(secret_key_base); end

  private

  # source://railties/6.1.7.8/lib/rails/application.rb#631
  def build_middleware; end

  # source://railties/6.1.7.8/lib/rails/application.rb#624
  def build_request(env); end

  # source://railties/6.1.7.8/lib/rails/application.rb#635
  def coerce_same_site_protection(protection); end

  # source://railties/6.1.7.8/lib/rails/application.rb#608
  def generate_development_secret; end

  class << self
    # source://railties/6.1.7.8/lib/rails/application.rb#358
    def add_lib_to_load_path!(root); end

    # source://railties/6.1.7.8/lib/rails/application.rb#103
    def create(initial_variable_values = T.unsafe(nil), &block); end

    # source://railties/6.1.7.8/lib/rails/application.rb#107
    def find_root(from); end

    # source://railties/6.1.7.8/lib/rails/application.rb#92
    def inherited(base); end

    # source://railties/6.1.7.8/lib/rails/application.rb#99
    def instance; end
  end
end
...
class Rails::Application::Configuration < ::Rails::Engine::Configuration
  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#29
  def initialize(*_arg0); end

  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#14
  ...
  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#342
  def annotations; end

  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#27
  def api_only; end

  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#223
  ...
  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#362
  ...
  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#302
  def colorize_logging; end

  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#306
  ...
  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#346
  ...
  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#277
  def database_configuration; end

  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#230
  def debug_exception_response_format; end

  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#234
  def debug_exception_response_format=(_arg0); end

  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#374
  ...
  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#215
  ...
  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#259
  def load_database_yaml; end

  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#85
  ...
  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#236
  def paths; end

  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#354
  ...
  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#311
  def session_store(new_session_store = T.unsafe(nil), **options); end

  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#338
  ...
  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#423
  def credentials_available_for_current_env?; end

  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#407
  def default_credentials_content_path; end

  # source://railties/6.1.7.8/lib/rails/application/configuration.rb#415
