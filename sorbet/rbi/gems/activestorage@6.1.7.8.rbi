...
class ActiveRecord::Base
  ...
  # source://activerecord/6.1.7.8/lib/active_record/reflection.rb#12
  ...
  # source://activemodel/6.1.7.8/lib/active_model/attribute_methods.rb#72
  def attribute_aliases; end

  # source://activemodel/6.1.7.8/lib/active_model/attribute_methods.rb#72
  def attribute_aliases?; end

  # source://activemodel/6.1.7.8/lib/active_model/attribute_methods.rb#73
  def attribute_method_matchers; end

  # source://activemodel/6.1.7.8/lib/active_model/attribute_methods.rb#73
  def attribute_method_matchers?; end

  # source://activerecord/6.1.7.8/lib/active_record/integration.rb#16
  def cache_timestamp_format; end

  # source://activerecord/6.1.7.8/lib/active_record/integration.rb#16
  def cache_timestamp_format?; end

  # source://activerecord/6.1.7.8/lib/active_record/integration.rb#24
  def cache_versioning; end

  # source://activerecord/6.1.7.8/lib/active_record/integration.rb#24
  def cache_versioning?; end

  # source://activerecord/6.1.7.8/lib/active_record/integration.rb#32
  def collection_cache_versioning; end

  # source://activerecord/6.1.7.8/lib/active_record/integration.rb#32
  def collection_cache_versioning?; end

  # source://activerecord/6.1.7.8/lib/active_record/model_schema.rb#144
  def column_for_attribute(*_arg0, &_arg1); end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#150
  def default_connection_handler; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#150
  def default_connection_handler?; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#152
  def default_role; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#152
  def default_role?; end

  # source://activerecord/6.1.7.8/lib/active_record/scoping/default.rb#11
  def default_scope_override; end

  # source://activerecord/6.1.7.8/lib/active_record/scoping/default.rb#10
  def default_scopes; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#154
  def default_shard; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#154
  def default_shard?; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#77
  ...
  # source://activerecord/6.1.7.8/lib/active_record/core.rb#39
  def destroy_association_async_job; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#107
  def dump_schema_after_migration; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#116
  def dump_schemas; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#94
  def error_on_ignored_order; end

  # source://activemodel/6.1.7.8/lib/active_model/serializers/json.rb#15
  def include_root_in_json; end

  # source://activemodel/6.1.7.8/lib/active_model/serializers/json.rb#15
  def include_root_in_json?; end

  # source://activerecord/6.1.7.8/lib/active_record/autosave_association.rb#153
  def index_nested_attribute_errors; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#156
  def legacy_connection_handling; end

  # source://activerecord/6.1.7.8/lib/active_record/locking/optimistic.rb#56
  def lock_optimistically; end

  # source://activerecord/6.1.7.8/lib/active_record/locking/optimistic.rb#56
  def lock_optimistically?; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#20
  def logger; end

  # source://activemodel/6.1.7.8/lib/active_model/naming.rb#237
  def model_name(*_arg0, &_arg1); end

  # source://activerecord/6.1.7.8/lib/active_record/nested_attributes.rb#15
  def nested_attributes_options; end

  # source://activerecord/6.1.7.8/lib/active_record/nested_attributes.rb#15
  def nested_attributes_options?; end

  # source://activerecord/6.1.7.8/lib/active_record/attribute_methods/dirty.rb#17
  def partial_writes; end

  # source://activerecord/6.1.7.8/lib/active_record/attribute_methods/dirty.rb#17
  def partial_writes?; end

  # source://activerecord/6.1.7.8/lib/active_record/model_schema.rb#136
  def pluralize_table_names; end

  # source://activerecord/6.1.7.8/lib/active_record/model_schema.rb#136
  def pluralize_table_names?; end

  # source://activerecord/6.1.7.8/lib/active_record/model_schema.rb#130
  def primary_key_prefix_type; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#171
  def raise_int_wider_than_64bit; end

  # source://activerecord/6.1.7.8/lib/active_record/timestamp.rb#47
  ...
  # source://activerecord/6.1.7.8/lib/active_record/core.rb#87
  def schema_format; end

  # source://activerecord/6.1.7.8/lib/active_record/signed_id.rb#13
  def signed_id_verifier_secret; end

  # source://activerecord/6.1.7.8/lib/active_record/attribute_methods/time_zone_conversion.rb#66
  def skip_time_zone_conversion_for_attributes; end

  # source://activerecord/6.1.7.8/lib/active_record/attribute_methods/time_zone_conversion.rb#66
  def skip_time_zone_conversion_for_attributes?; end

  # source://activerecord/6.1.7.8/lib/active_record/inheritance.rb#41
  def store_full_class_name; end

  # source://activerecord/6.1.7.8/lib/active_record/inheritance.rb#41
  def store_full_class_name?; end

  # source://activerecord/6.1.7.8/lib/active_record/inheritance.rb#45
  def store_full_sti_class; end

  # source://activerecord/6.1.7.8/lib/active_record/inheritance.rb#45
  def store_full_sti_class?; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#130
  def suppress_multiple_database_warning; end

  # source://activerecord/6.1.7.8/lib/active_record/model_schema.rb#132
  def table_name_prefix; end

  # source://activerecord/6.1.7.8/lib/active_record/model_schema.rb#132
  def table_name_prefix?; end

  # source://activerecord/6.1.7.8/lib/active_record/model_schema.rb#133
  def table_name_suffix; end

  # source://activerecord/6.1.7.8/lib/active_record/model_schema.rb#133
  def table_name_suffix?; end

  # source://activerecord/6.1.7.8/lib/active_record/attribute_methods/time_zone_conversion.rb#64
  def time_zone_aware_attributes; end

  # source://activerecord/6.1.7.8/lib/active_record/attribute_methods/time_zone_conversion.rb#67
  def time_zone_aware_types; end

  # source://activerecord/6.1.7.8/lib/active_record/attribute_methods/time_zone_conversion.rb#67
  def time_zone_aware_types?; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#99
  def timestamped_migrations; end

  # source://activerecord/6.1.7.8/lib/active_record/model_schema.rb#144
  def type_for_attribute(*_arg0, &_arg1); end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#160
  def use_yaml_unsafe_load; end

  # source://activemodel/6.1.7.8/lib/active_model/validations.rb#48
  def validation_context; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#27
  def verbose_query_logs; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#124
  def warn_on_records_fetched_greater_than; end

  # source://activerecord/6.1.7.8/lib/active_record/core.rb#164
  ...
  class << self
    ...
    # source://activerecord/6.1.7.8/lib/active_record/readonly_attributes.rb#8
    ...
    # source://activerecord/6.1.7.8/lib/active_record/core.rb#140
    def action_on_strict_loading_violation; end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#140
    def action_on_strict_loading_violation=(val); end

    # source://activemodel/6.1.7.8/lib/active_model/callbacks.rb#144
    ...
    # source://activerecord/6.1.7.8/lib/active_record/core.rb#295
    def allow_unsafe_raw_sql; end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#299
    def allow_unsafe_raw_sql=(value); end

    # source://activemodel/6.1.7.8/lib/active_model/callbacks.rb#137
    ...
    # source://activemodel/6.1.7.8/lib/active_model/callbacks.rb#130
    ...
    # source://activerecord/6.1.7.8/lib/active_record/core.rb#134
    ...
    # source://activerecord/6.1.7.8/lib/active_record/core.rb#69
    def configurations; end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#63
    def configurations=(config); end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#262
    def connected_to_stack; end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#276
    def connection_class; end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#272
    def connection_class=(b); end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#280
    def connection_class?; end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#284
    def connection_classes; end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#175
    def connection_handler; end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#179
    def connection_handler=(handler); end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#183
    def connection_handlers; end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#191
    def connection_handlers=(handlers); end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#249
    def current_preventing_writes; end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#208
    def current_role; end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#230
    ...
    # source://activerecord/6.1.7.8/lib/active_record/core.rb#148
    def has_many_inversing; end

    # source://activerecord/6.1.7.8/lib/active_record/core.rb#148
    def has_many_inversing=(val); end

    # source://activerecord/6.1.7.8/lib/active_record/model_schema.rb#138
    ...
    # source://activerecord/6.1.7.8/lib/active_record/model_schema.rb#137
    ...
    # source://activerecord/6.1.7.8/lib/active_record/model_schema.rb#135
    ...
    # source://activerecord/6.1.7.8/lib/active_record/store.rb#99
    ...
    # source://activerecord/6.1.7.8/lib/active_record/core.rb#132
    ...
    # source://activerecord/6.1.7.8/lib/active_record/core.rb#33
    def queues; end
    ...
    # source://activerecord/6.1.7.8/lib/active_record/core.rb#146
    ...
    # source://activerecord/6.1.7.8/lib/active_record/model_schema.rb#134
    ...
    # source://activerecord/6.1.7.8/lib/active_record/core.rb#142
    ...
    # source://activerecord/6.1.7.8/lib/active_record/core.rb#307
    ...
    # source://activerecord/6.1.7.8/lib/active_record/core.rb#144
...
class ActiveStorage::AnalyzeJob < ::ActiveStorage::BaseJob
  ...
  class << self
    # source://activejob/6.1.7.8/lib/active_job/queue_name.rb#56
    def queue_name; end

    # source://activesupport/6.1.7.8/lib/active_support/rescuable.rb#13
...
module ActiveStorage::Attachment::GeneratedAssociationMethods
  ...
  # source://activerecord/6.1.7.8/lib/active_record/associations/builder/singular_association.rb#28
  def build_blob(*args, &block); end

  # source://activerecord/6.1.7.8/lib/active_record/associations/builder/singular_association.rb#32
  def create_blob(*args, &block); end

  # source://activerecord/6.1.7.8/lib/active_record/associations/builder/singular_association.rb#36
  def create_blob!(*args, &block); end
...
class ActiveStorage::BaseController < ::ActionController::Base
  ...
  # source://actionview/6.1.7.8/lib/action_view/layouts.rb#325
  ...
  class << self
    ...
    # source://actionpack/6.1.7.8/lib/action_controller/metal/etag_with_template_digest.rb#27
    def etag_with_template_digest; end

    # source://actionpack/6.1.7.8/lib/action_controller/metal.rb#212
...
class ActiveStorage::Blob < ::ActiveStorage::Record
  ...
  # source://actiontext/6.1.7.8/lib/action_text/engine.rb#33
  ...
  # source://activerecord/6.1.7.8/lib/active_record/autosave_association.rb#213
  ...
  # source://actiontext/6.1.7.8/lib/action_text/engine.rb#29
  def previewable_attachable?; end

  def purge; end
  def purge_later; end

  # source://activerecord/6.1.7.8/lib/active_record/secure_token.rb#39
  def regenerate_key; end

  def service; end
  def service_headers_for_direct_upload; end

  # source://activesupport/6.1.7.8/lib/active_support/deprecation/method_wrappers.rb#63
  ...
  # source://actiontext/6.1.7.8/lib/action_text/engine.rb#37
...
class ActiveStorage::Current < ::ActiveSupport::CurrentAttributes
  class << self
    # source://activesupport/6.1.7.8/lib/active_support/current_attributes.rb#114
    def host; end

    # source://activesupport/6.1.7.8/lib/active_support/current_attributes.rb#118
